    ...
    <div className="flex flex-col min-h-screen">
      <header className="px-4 lg:px-6 h-16 flex items-center justify-between">
        ...
        <nav className="flex gap-4 sm:gap-6">
          ...
          <Link href="/register" className="text-sm font-medium hover:underline underline-offset-4">Register</Link>
        </nav>
      ...
      <footer className="px-4 lg:px-6 py-4 text-center">
        <p className="text-sm text-gray-600">
          &copy; {new Date().getFullYear()} TimeOffer. All rights reserved.
        </p>
      </footer>
    </div>
  );
